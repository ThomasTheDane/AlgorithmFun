import string
PATH_TO_FILE = '/Users/thomasnattestad/workspaces/AlgorithmFun/compThink/words.txt'
...
def loadWords2():
 	...
 	print "  ", len(wordlist), "words loaded."
 	return wordlist
PATH_TO_FILE = '/Users/thomasnattestad/workspaces/AlgorithmFun/compThink/words2.txt'
loadWords2()
